        ...
        <div className="center-hrz">
          <div className="social__container">
              <div className="center-hrz--col link-ind-container">
                <a href="https://docdro.id/xrb4bEl" target="_blank" rel="noreferrer" className="social__link" title="resume" style={{ color: theme.accent }}><i className="fas fa-download"></i></a>
