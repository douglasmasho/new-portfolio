        ...
        <div className="timeline-item">
            ...
            <div className="timeline-item__thumb" data-aos="zoom-out" data-aos-delay="400" data-aos-duration="500">
                <div className="timeline-item__thumb__overlay">
                    <a href={item.gitlink} target="_blank"><i className="fab fa-github" title="View Github"></i></a>
                    <a href={item.demolink} target="_blank"><i className="icon fas fa-eye" title="Demo"></i></a>
                </div>
